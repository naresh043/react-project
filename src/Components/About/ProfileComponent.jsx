  ...
  const cleanDataForSubmission = (data) => {
    ...
    if (cleanedData.socialLinks) {
      Object.keys(cleanedData.socialLinks).forEach((key) => {
        if (
          !cleanedData.socialLinks[key] ||
          cleanedData.socialLinks[key].trim() === ""
        ) {
    ...
    if (cleanedData.interests) {
      cleanedData.interests = cleanedData.interests.filter(
      ...
      <div className="profile-container">
        <div className="profile-wrapper">
          ...
          <div className="profile-stats">
            <div onClick={handleEnrolledCoursesClick} className="stat-card">
